...
public class PaymentService {
    ...
    public PaymentCompleteResponseDTO verifyPayment(PaymentRequestDTO paymentRequestDTO) {
        ...
        try {
            ...
            ArrayList<ProductInOrderResponseDTO> productInOrderResponseDTOList = new ArrayList<>();
            ...
            for (int i = 0; i < order.getProducts().size(); i++) {
                ...
                productInOrderResponseDTO = ProductInOrderResponseDTO.toProductInOrderResponseDTO(product, productNum);

                productInOrderResponseDTOList.add(productInOrderResponseDTO);
            }

            PaymentCompleteResponseDTO paymentCompleteResponseDTO = PaymentCompleteResponseDTO.toPaymentCompleteResponseDTO(order, productInOrderResponseDTOList);
